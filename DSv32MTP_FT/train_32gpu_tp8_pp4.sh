...
OUTPUT_DIR="/data/finetuned_layer61_tp8_pp4"

# Parallelism (32 GPUs Required)
# Configured for 4 nodes x 8 GPUs = 32 GPUs
# TP=8 (fit in one node), PP=4 (across 4 nodes)
# Run this script on EACH node with appropriate NODE_RANK ranges (0, 1, 2, 3)
...
echo "Starting DeepSeek-V3.2 32-GPU Fine-tuning (TP=${TP}, PP=${PP})..."
...
# Total 61 Layers. PP=4.
# Split suggestion: 16 (First) + 15 (Middle) + 15 (Middle) + 15 (Last) = 61
# First stage has 16 layers as specified.
PP_ARGS=(
