...
OUTPUT_DIR="/data/finetuned_layer60_test_tp8"

# Parallelism: 8x H200, TP=8, EP=1
# 使用 TP=8 分割模型，减少每个GPU显存使用
NPROC_PER_NODE=8
...
# ===== Check =====
echo "============================================"
echo "DeepSeek-V3.2 MTP Fine-tuning (TP=8)"
echo "============================================"
